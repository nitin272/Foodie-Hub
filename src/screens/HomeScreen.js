...
import { StyleSheet, Text, View, ScrollView, TouchableOpacity, Animated, Dimensions, Image, RefreshControl } from 'react-native';
...
export default function HomeScreen({ navigation }) {
  ...
  const onRefresh = () => {
    ...
    setTimeout(() => {
      setRefreshing(false);
      showToast('Restaurants updated!', 'success');
    }, 2000);
  };
